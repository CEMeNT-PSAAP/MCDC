...
def animate(k):
    ...
    ax.fill_between(x_mid, phi[k, :]-phi_sd[k, :],
                    phi[k, :]+phi_sd[k, :], alpha=0.2, color='b')
...
def animate(k):
    ...
    ax.collections.clear()
    ax.fill_between(x, phi_x[k, :]-phi_x_sd[k, :],
                    phi_x[k, :]+phi_x_sd[k, :], alpha=0.2, color='b')
...
def animate(k):
    ...
    ax.collections.clear()
    ax.fill_between(x_mid, phi_t[k, :]-phi_t_sd[k, :],
                    phi_t[k, :]+phi_t_sd[k, :], alpha=0.2, color='b')
