...
def animate(k):
    ...
    ax2.fill_between(E_mid, phi[:, k]-phi_sd[:, k], phi[:, k] +
                     phi_sd[:, k], alpha=0.2, color='b', step='mid')
...
simulation.save('inf.gif', savefig_kwargs={
                'bbox_inches': 'tight', 'pad_inches': 0})
simulation.save('inf.mp4', savefig_kwargs={
                'bbox_inches': 'tight', 'pad_inches': 0})
plt.show()
