...
# Material types
# TODO: Remove these after Material no longer uses polymorphic type IDs.
MATERIAL = 0
MATERIAL_MG = 1

# Neutron multigroup energy-grid organization
MULTIGROUP_NEUTRON_GRID_SHARED = 0
MULTIGROUP_NEUTRON_GRID_LOCAL = 1

# Neutron multigroup energy representation
MULTIGROUP_NEUTRON_ENERGY_MIDPOINT = 0
MULTIGROUP_NEUTRON_ENERGY_MIDPOINT_LOG = 1
MULTIGROUP_NEUTRON_ENERGY_UNIFORM = 2
MULTIGROUP_NEUTRON_ENERGY_UNIFORM_LOG = 3
