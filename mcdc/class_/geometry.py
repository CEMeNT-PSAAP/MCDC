...
class Surface(ABC):
    ...
    ----------------
    evaluate(position)
        Evaluate if position is on the + or - side of the surface
    distance(position, direction)
        Return the distance for a ray with position and direction to hit the 
        surface
    normal(position, direction)
        Return dot product of the surface normal+ and a ray at position
        with direction. This is used for some surface 
        tallies
    """
    ...
    # Abstract methods
    @abstractmethod
    def evaluate(self, position, t):
        pass
    @abstractmethod
    def distance(self, position, direction, t, speed):
        pass
    @abstractmethod
    def normal(self, position, direction, t):
        pass
