...
Read :doc:`philosophy` when deciding what information belongs in a page and how
to layer it for different audiences. Read :doc:`sphinx` for source layout,
reStructuredText, API generation, and local build instructions.
