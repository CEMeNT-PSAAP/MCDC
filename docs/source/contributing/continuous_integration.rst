...
We use `GitHub Actions <https://github.com/mcdc-project/mcdc/actions>`_ to host and run most of our CI tests and version release information.
...
CEMeNT currently has a `CI machine <https://github.com/mcdc-project/mcdc/settings/actions/runners>`_ on OSU's campus administered by the college of engineering HPC folks to do export controlled and GPU continuous integration.
