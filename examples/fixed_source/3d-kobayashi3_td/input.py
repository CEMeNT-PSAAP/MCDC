...
mcdc.source(x=[0.0, 10.0], y=[0.0, 10.0], z=[0.0, 10.0], t=[0.0, 50.0],
            isotropic=True)
...
mcdc.tally(scores=['flux'], x=[0.0, 60.0, 60], y=[0.0, 100.0, 100], 
                            t=[0.0, 200.0, 20])

# Setting
mcdc.setting(N_hist=N_hist, time_boundary=200.0, progress_bar=False, output=output)
mcdc.run()
