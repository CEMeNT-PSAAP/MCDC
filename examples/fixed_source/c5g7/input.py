...
mcdc.domain_decomp(x= np.linspace(0.0, pitch * 17 * 3, 3),z=np.linspace(-(core_height / 2 + refl_thick), (core_height / 2 + refl_thick),3),y= np.linspace( -pitch * 17 * 3,0.0, 3))#,z=np.linspace(-(core_height / 2 + refl_thick), (core_height / 2 + refl_thick),3))
# Run
mcdc.run()
